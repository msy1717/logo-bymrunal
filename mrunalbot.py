...
async def lego(event):
 ...
 try:
    ...
    img = Image.open('./MrunalIsbest/resources/blackbg.jpg')
    draw = ImageDraw.Draw(img)
    image_widthz, image_heightz = img.size
    pointsize = 500
    fillcolor = "gold"
    shadowcolor = "blue"
    font = ImageFont.truetype("./MrunalIsbest/resources/Chopsic.otf", 330)
...
async def lego(event):
 ...
 try:
    text = event.pattern_match.group(1)
    img = Image.open('./MrunalIsbest/resources/blackbg.jpg')
    #dont touch name if you dont know coding if you know and you change your mom fucked by me
    draw = ImageDraw.Draw(img)
    image_widthz, image_heightz = img.size
    pointsize = 500
    fillcolor = "white"
    shadowcolor = "blue"
    font = ImageFont.truetype("./MrunalIsbest/resources/Maghrib.ttf", 1000)
  #dont touch name if you dont know coding if you know and you change your mom fucked by me
    ...
    img.save(fname2, "png")
    await tbot.send_file(event.chat_id, fname2, caption="Made By @TelebotsscHATt")
    if os.path.exists(fname2):
            os.remove(fname2)
 except Exception as e:
   await event.reply(f'Error Report @TelebotsscHAT, {e}')
